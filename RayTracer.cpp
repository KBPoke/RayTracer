...
int main()
{
    std::shared_ptr<Plane> plane = std::make_shared<Plane>(Vec3(0,0,0),Vec3(0,-1,0),color(0.1,1,0));
    ...
    SceneObjects.push_back(std::make_shared<Sphere>(Point3(0.1, 0.6, 0.4), 0.2, color(0, 0, 0), Fresnel));
